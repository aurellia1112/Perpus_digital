...
<div class="py-12">
       <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
           <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
               <a href="{{ route('admin.user.create') }}" class="bg-emerald-600 hover:bg-emerald-700 text-white font-semibold px-4 py-2 rounded-md mb-4 inline-block shadow">+ Tambah Anggota</a>
                   ...
                   <tbody>
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="border border-gray-300 p-2 text-center">{{ $index + 1 }}</td>
                            ...
                            <td class="border border-gray-300 p-2 text-center">
                               <a href="{{ route('admin.user.edit', $usr->id) }}" class="bg-amber-500 hover:bg-amber-600 text-white font-medium px-3 py-1 rounded text-sm shadow inline-block">Edit</a>
